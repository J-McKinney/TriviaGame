$("document").ready(function () {
    ...
    $("#h200").on("click", function () {
        $(".lead").html(twoH[0]);
        $("#ans1").html(twoH[1]).on("mousedown", function () {
            // alert("Correct Answer, Please Pick Another Category");
            alert("Wrong Answer, Please Pick Another Category");
        });
        $("#ans2").html(twoH[2]).on("mousedown", function () {
            // alert("Correct Answer, Please Pick Another Category");
            alert("Wrong Answer, Please Pick Another Category");
        });
        ...
        $("#ans4").html(twoH[4]).on("mousedown", function () {
            // alert("Correct Answer, Please Pick Another Category");
            alert("Wrong Answer, Please Pick Another Category");
        });
    })
    ...
    $("#h300").on("click", function () {
        $(".lead").html(threeH[0]);
        $("#ans1").html(threeH[1]).on("mousedown", function () {
            // alert("Correct Answer, Please Pick Another Category");
            alert("Wrong Answer, Please Pick Another Category");
        });
        ...
        $("#ans3").html(threeH[3]).on("mousedown", function () {
            // alert("Correct Answer, Please Pick Another Category");
            alert("Wrong Answer, Please Pick Another Category");
        });
        $("#ans4").html(threeH[4]).on("mousedown", function () {
            // alert("Correct Answer, Please Pick Another Category");
            alert("Wrong Answer, Please Pick Another Category");
        });
    })
    ...
    $("#h500").on("click", function () {
        $(".lead").html(fiveH[0]);
        $("#ans1").html(fiveH[1]).on("mousedown", function () {
            // alert("Correct Answer, Please Pick Another Category");
            alert("Wrong Answer, Please Pick Another Category");
        });
        $("#ans2").html(fiveH[2]).on("mousedown", function () {
            // alert("Correct Answer, Please Pick Another Category");
            alert("Wrong Answer, Please Pick Another Category");
        });
        $("#ans3").html(fiveH[3]).on("mousedown", function () {
            // alert("Correct Answer, Please Pick Another Category");
            alert("Wrong Answer, Please Pick Another Category");
        });
